...
export default async function Home() { // ✅ Mark function as async
  const { userId } = await auth(); // ✅ Await the auth() response 
  ...
  return (
    <div className="h-screen">
      <div className="grid grid-cols-1 md:grid-cols-3 h-full">
        ...
        {/* Booking Section - Allow Expansion Without Affecting Map */}
        <div className="md:h-auto">
          <Booking />
        </div>

        {/* Google Map Embed (Replacing MapBoxMap) */}
